...
% Generate a standard particle size distribution (PSD) plot.
%
...
% for each horizon. Therefore, the percentage of material up to and including
% the class in the last column is not plotted as it should be a vertical line at
...
stairDepth = [zeros(1, nClass - 1); stairDepth(1, :);...
              stairDepth(1:(2 * nHorz - 2),:)];
stairFraction = [stairFraction(1:(2 * nHorz - 1), :);...
                 stairFraction((2 * nHorz - 1), :)];
