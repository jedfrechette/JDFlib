...
def main_gui():
    ...
    while True:
        ...
        if event == "Submit":
            ...
            loading_window = sg.Window("Loading", loading_layout, finalize=True, size=(275, 200))
            ...
            if 'error' in result_holder:
                ...
                result_window = sg.Window("Recommendation", result_layout, finalize=True, size=(275, 200))
                while True:
