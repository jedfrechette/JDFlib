...
def wtFromUTCpy(pyUTC, leapSecs=15):
...
def gpsFromUTC(year, month, day, hour, min, sec, leapSecs=15):
...
def UTCFromGps(gpsWeek, SOW, leapSecs=15):
...
def GpsSecondsFromPyUTC( pyUTC, leapSecs=15 ):
